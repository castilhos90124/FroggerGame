...
public final class Keyboard extends InputBase implements KeyListener {
    ...
    /**
     * Create instance of class Keyboard with the following keys and its
     * behavior: UP_KEY, LEFT_KEY, RIGHT_KEY, DOWN_KEY have the behavior
     * DETECT_EVERY_PRESS, and the keys ESCAPE_KEY, SPACE_KEY, ENTER_KEY have
     * the behavior DETECT_INITIAL_PRESS_ONLY.
     *
     * @version 1.0
     */
    public Keyboard() {
         ...
         */
        addKey(KeyEvent.VK_ESCAPE, Keyboard.DETECT_INITIAL_PRESS_ONLY);
        addKey(KeyEvent.VK_UP, Keyboard.DETECT_INITIAL_PRESS_ONLY);
        addKey(KeyEvent.VK_DOWN, Keyboard.DETECT_INITIAL_PRESS_ONLY);
        addKey(KeyEvent.VK_LEFT, Keyboard.DETECT_INITIAL_PRESS_ONLY);
        addKey(KeyEvent.VK_RIGHT, Keyboard.DETECT_INITIAL_PRESS_ONLY);
        addKey(KeyEvent.VK_ENTER, Keyboard.DETECT_INITIAL_PRESS_ONLY);
    ...
    /**
     * Overloading the method void addKey(int key, int behavior), the behavior
     * will be DETECT_INITAL_PRESS_ONLY.
     *
    ...
    /**
     * Method used for adding a key to an instance of the keyboard and its
     * behavior.
     *
     * @param key The key code. The key code can be found in 'KeyEvent.'.
